...
resourcename="charitableeducationapp"  # lower case, only
resourcegroup="charitableeducationapp_rg"
...
# git clone https://github.com/apilogicserver/charitableeducationapp.git
# cd charitableeducationapp
...
az group create --name charitableeducationapp_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group charitableeducationapp_rg --sku S1 --is-linux
az container create --resource-group charitableeducationapp_rg --name charitableeducationapp --image apilogicserver/charitableeducationapp:latest --dns-name-label charitableeducationapp --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//charitableeducationapp.westus.azurecontainer.io:5656'
